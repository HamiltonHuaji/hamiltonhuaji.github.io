...
这个类不是一般的复杂, 因此我们可以尝试从一部分简单的逻辑入手, 来挖掘 ojng 程序员惯用的编码模式.
...
通过搜索 `starsBuffer` 的用法, 可以发现 net/minecraft/client/render/WorldRenderer.java:1596 的 `public void renderSky(MatrixStack...)` 函数实际上执行了星空的绘制.
